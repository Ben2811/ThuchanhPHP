    ...
    <div class="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <div class="animate-fade-in">
            ...
            <p class="text-lg text-gray-600 max-w-2xl mx-auto">
                Tạo danh mục sản phẩm mới để tổ chức cửa hàng của bạn một cách hiệu quả
            </p>
        </div>
    </div>
</div>

<div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">    <!-- Error Messages -->
    ...
    <div class="animate-slide-up bg-white rounded-xl shadow-lg border border-gray-100 overflow-hidden">
        ...
        </div>        <form method="POST" action="/WebBanHang/Category/save" class="p-6 space-y-6">
            <!-- Category Name -->
            <div class="group">
