...
<div class="container mx-auto px-4 mt-8">
    <h1 class="text-3xl font-bold text-gray-800 mb-6">Thêm danh mục mới</h1>
    ...
    <div class="bg-white shadow-md rounded-lg p-6">
        <form method="POST" action="/WebBanHang/Category/save">
            <div class="mb-4">
                ...
                <input type="text" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent" id="name" name="name" required>
            </div>
            ...
            <div class="flex space-x-4">
                <button type="submit" class="bg-blue-500 hover:bg-blue-600 text-white font-medium py-2 px-6 rounded transition duration-200">Thêm danh mục</button>
